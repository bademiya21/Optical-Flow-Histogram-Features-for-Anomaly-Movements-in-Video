...
SVECTOR *create_svector(WRD *, FNUM, char *, double);
...
/*From binary_format.c*/
int read_feature(FILE *, WRD *, double *, int , int, long *, long *, double *, long int *, long int , char **);

int    parse_document(char *, WRD *, double *, long *, long *, double *, long *, long, char **);
...
void   read_binary_documents(const char *, DOC ***, double **, long *, long *, long *);
